    ...
    //implements Zend_Tool_Framework_Provider_DocblockManifestInterface
{
    ...
    public function create($path, $nameOfProfile = null, $fileOfProfile = null)
    {
        ...
        $response->appendContent(
            ...
            . 'for more information setting up your VHOST, please see docs/README.md');
...
<projectProfile type="default" version="$version">
    <projectDirectory>
        ...
        <docsDirectory>
            <file filesystemName="README.md.txt" defaultContentCallback="Zend_Tool_Project_Provider_Project::getDefaultReadmeContents"/>
        </docsDirectory>
        <libraryDirectory>
